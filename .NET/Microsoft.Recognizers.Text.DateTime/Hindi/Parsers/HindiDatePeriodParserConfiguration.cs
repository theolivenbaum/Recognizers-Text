...
namespace Microsoft.Recognizers.Text.DateTime.Hindi
{
    public class HindiDatePeriodParserConfiguration : BaseDateTimeOptionsConfiguration, IDatePeriodParserConfiguration
    {
            ...
            : base(config)
        {
            ...
            MonthFrontBetweenRegex = HindiDatePeriodExtractorConfiguration.MonthFrontBetweenRegex;
            BetweenRegex = HindiDatePeriodExtractorConfiguration.BetweenRegex;
            MonthFrontSimpleCasesRegex = HindiDatePeriodExtractorConfiguration.MonthFrontSimpleCasesRegex;
            SimpleCasesRegex = HindiDatePeriodExtractorConfiguration.SimpleCasesRegex;
            OneWordPeriodRegex = HindiDatePeriodExtractorConfiguration.OneWordPeriodRegex;
            MonthWithYear = HindiDatePeriodExtractorConfiguration.MonthWithYear;
            ...
            WeekOfYearRegex = HindiDatePeriodExtractorConfiguration.WeekOfYearRegex;
            QuarterRegex = HindiDatePeriodExtractorConfiguration.QuarterRegex;
            QuarterRegexYearFront = HindiDatePeriodExtractorConfiguration.QuarterRegexYearFront;
            AllHalfYearRegex = HindiDatePeriodExtractorConfiguration.AllHalfYearRegex;
            SeasonRegex = HindiDatePeriodExtractorConfiguration.SeasonRegex;
            WhichWeekRegex = HindiDatePeriodExtractorConfiguration.WhichWeekRegex;
            WeekOfRegex = HindiDatePeriodExtractorConfiguration.WeekOfRegex;
            MonthOfRegex = HindiDatePeriodExtractorConfiguration.MonthOfRegex;
            RestOfDateRegex = HindiDatePeriodExtractorConfiguration.RestOfDateRegex;
            LaterEarlyPeriodRegex = HindiDatePeriodExtractorConfiguration.LaterEarlyPeriodRegex;
            WeekWithWeekDayRangeRegex = HindiDatePeriodExtractorConfiguration.WeekWithWeekDayRangeRegex;
            YearPlusNumberRegex = HindiDatePeriodExtractorConfiguration.YearPlusNumberRegex;
            DecadeWithCenturyRegex = HindiDatePeriodExtractorConfiguration.DecadeWithCenturyRegex;
            YearPeriodRegex = HindiDatePeriodExtractorConfiguration.YearPeriodRegex;
            ComplexDatePeriodRegex = HindiDatePeriodExtractorConfiguration.ComplexDatePeriodRegex;
            RelativeDecadeRegex = HindiDatePeriodExtractorConfiguration.RelativeDecadeRegex;
            InConnectorRegex = config.UtilityConfiguration.InConnectorRegex;
            WithinNextPrefixRegex = HindiDatePeriodExtractorConfiguration.WithinNextPrefixRegex;
            ReferenceDatePeriodRegex = HindiDatePeriodExtractorConfiguration.ReferenceDatePeriodRegex;
            AgoRegex = HindiDatePeriodExtractorConfiguration.AgoRegex;
            LaterRegex = HindiDatePeriodExtractorConfiguration.LaterRegex;
            LessThanRegex = HindiDatePeriodExtractorConfiguration.LessThanRegex;
